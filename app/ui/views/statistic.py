...
class StatisticView(QWidget):
    ...
    def init_ui(self):
        ...
        self.date_from.setDate(QDate.currentDate().addMonths(-1)) # За замовчуванням - останній місяць
        ...
        # Регіон та Район (Тільки для Адміна)
        if self.role == 'admin':
        ...
        # Хвороби (Мульти-вибір через QListWidget)
        ...
        # Кнопка Оновити
        self.btn_refresh = QPushButton("Показати статистику")
        ...
        # 2. ЦЕНТРАЛЬНА ЧАСТИНА (Таблиця + Графік)
        ...
        self.plot_widget.setBackground('w') # Білий фон
        self.plot_widget.setTitle("ТОП Захворювань", color="k", size="12pt")
    ...
    def refresh_stats(self):
        ...
        # Отримуємо обрані хвороби (список)
        ...
        # 2. Отримуємо дані з БД (Залежно від ролі)
        if self.role == 'admin':
